...
ENROLLMENT_NO VARCHAR(20), NAME VARCHAR(25), CPI DECIMAL(5,2), BIRTHDATE DATETIME)
...
EMPNO INT, EMPNAME VARCHAR(25), JOININGDATE DATETIME, SALARY DECIMAL(8,2), CITY VARCHAR(20))
